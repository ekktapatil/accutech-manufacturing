          ...
          <div className="grid items-center gap-14 lg:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-8 text-lg leading-8 text-slate-600">
                Accutech Manufacturing designs and installs customized
                assembly line systems that improve production efficiency,
                reduce downtime and streamline industrial operations for
          ...
          <div className="grid gap-10 lg:grid-cols-3">
            ...
            <div className="rounded-3xl bg-white p-10 shadow-lg lg:col-span-2">
              ...
              <div className="mt-8 space-y-6 text-lg leading-8 text-slate-600">
                ...
                <p>
                  Our Assembly Line solutions are designed to improve
                  manufacturing productivity through efficient workflow,
                  optimized layouts and modern automation concepts.
                </p>

                <p>
                  We manufacture assembly stations, conveyors,
                  worktables, machine platforms, operator stations and
                  production support systems tailored to customer needs.
                </p>

                <p>
                  Every solution is developed for reliability,
                  operational efficiency and long-term industrial
                  performance.
                </p>
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="rounded-[35px] bg-white p-12 shadow-lg">
            ...
            <p className="mx-auto mt-5 max-w-3xl text-center text-lg text-slate-600">
              Complete assembly line solutions engineered for modern
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="text-center">
            ...
            <p className="mt-5 text-lg text-slate-600">
              Smart manufacturing solutions designed to improve
              productivity, efficiency and long-term reliability.
            </p>
            ...
            {[
              {
                ...
                desc: "Assembly lines designed to maximize productivity and reduce downtime.",
                icon: "⚙️",
              },
              {
                title: "Custom Solutions",
                desc: "Every assembly line is engineered according to your production requirements.",
                icon: "🏭",
              },
              {
                title: "Expert Installation",
                desc: "Professional installation ensuring smooth and reliable operation.",
                icon: "👷",
              },
              {
                title: "After-Sales Support",
                desc: "Comprehensive maintenance and technical assistance whenever required.",
                icon: "🛠️",
              },
            ].map((item) => (
              <div
      ...
      <section className="bg-white py-24">
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="text-center">
            ...
            <p className="mt-5 text-lg text-slate-600">
              From concept to commissioning, every assembly line follows
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="rounded-[40px] bg-gradient-to-r from-orange-600 to-orange-500 p-16 text-center shadow-2xl">
            ...
            <p className="mx-auto mt-6 max-w-3xl text-lg leading-8 text-orange-100">
              Improve efficiency, increase productivity and streamline
              your manufacturing process with customized assembly line
              solutions from Accutech Manufacturing.
            </p>
